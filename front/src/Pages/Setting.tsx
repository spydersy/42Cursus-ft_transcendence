...
export default function Setting() {
    ...
    useEffect(() => {
        ...
        axios.get("/back-end/profile/me",   {withCredentials: true} 
        ).then((res)=>{
        ...
        e?.addEventListener("change", (c :any)=>{
            ...
            bodyFormData.append('avatar', c.target.files[0]);
                axios.post("/back-end/profile/updateAvatar", bodyFormData, {withCredentials: true}).then((res)=>{
                    console.log(res)
    ...
    const submitHandler = () => {
        ...
        axios.put("/back-end/profile/updateUsername/" + name , name, {withCredentials: true}).then((res)=>{
            wait(2000).then(() => {
                setColor("#ff000d");
                setLoading(false);
            })
        ...
        axios.put("/back-end/profile/update2fa/" + checked , { checked}, {withCredentials: true}).then((res)=>{
            wait(2000).then(() => {
                setLoading(false); })
