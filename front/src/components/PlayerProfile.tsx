...
// State  // 
  export function Stats(props: PlayerCardProps) {
    ...
    const addFriend = ()=>{
        ///back-end/users/relation/:id?evet=add
        axios.get("/back-end/users/relation/"+ props.player.login+ "?event=add",   {withCredentials: true} 
        ).then((res)=>{
    ...
    const CancelRequest = ()=>{
      axios.get("/back-end/users/relation/"+ props.player.login+ "?event=cancel",   {withCredentials: true}
      ).then((res)=>{
      // console.log(res.data)
      // alert("friend Request sent" + res.status)
    ...
    const UnfriendUser = ()=>{
      //  GET /back-end/users/relation/:id?event=unfriend
      axios.get("/back-end/users/relation/"+ props.player.login+ "?event=unfriend",   {withCredentials: true} 
      ).then((res)=>{
      // console.log(res.data)
      // alert("friend Request sent" + res.status)
      setrelationStatus("NOTHING")
    ...
    const BlockUser = ()=>{
      //  GET /back-end/users/relation/:id?event=block
      axios.get("/back-end/users/relation/"+ props.player.login+ "?event=block",   {withCredentials: true} 
      ).then((res)=>{
      // console.log(res.data)
      // alert("friend Request sent" + res.status)
    ...
    const UnBlockUser = ()=>{
      //  GET /back-end/users/relation/:id?event=unblock
      axios.get("/back-end/users/relation/"+ props.player.login+ "?event=unblock",   {withCredentials: true}
      ).then((res)=>{
      // console.log(res.data)
      // alert("friend Request sent" + res.status)
      setrelationStatus("NOTHING")
    ...
    useEffect(() => {
        ...
        axios.get("/back-end/users/" + id,  {withCredentials: true}).then((res)=>{
        ...
        axios.get("/back-end/users/achievements/" + id,  {withCredentials: true}).then((res)=>{
          // Achievenments          
