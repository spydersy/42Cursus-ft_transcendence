    ...
    const [currentConv, setcurrentConv] = useState(parseInt(pageName))
     useEffect(() => {
       const fetchData = async () => {
         await axios.get("/back-end/chat/myChannels", 
         {withCredentials: true} 
          ...
          //  console.log('> mychannells = '  , res.data, "} \n")
           ...
           axios.get("/back-end/chat/messages/" + res.data[currentConv]?.channelId, 
           {withCredentials: true} 
           ).then((res)=>{
             console.log('mychannells = '  , res.data, "} \n")
             setmsgs(res.data)
    ...
    useEffect(() => {
      const recievedMessgae  = async () => {
        if (list[currentConv]?.channelId  != undefined)
        {
          ...
          await axios.get("/back-end/chat/messages/" + list[currentConv]?.channelId, 
           {withCredentials: true} 
         ).then((res)=>{
