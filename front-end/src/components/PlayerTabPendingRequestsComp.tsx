...
export default function PendingRequests()
{
  ...
  useEffect(() => {
    ...
    axios.get("/back-end/profile/me?data=requests",  {withCredentials: true}  ).then((res)=>{
...
const accepteFriend = ()=>{
    axios.get("/back-end/users/relation/"+ props.data.login+ "?event=accept",  {withCredentials: true} 
            ).then((res)=>{
...
const DenyFriend = ()=>{
    axios.get("/back-end/users/relation/"+ props.data.login+ "?event=decline",  {withCredentials: true} 
            ).then((res)=>{
