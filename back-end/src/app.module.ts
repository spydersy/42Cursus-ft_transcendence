...
@Module({
  ...
  providers: [AppService, UserService, ProfileService, PrismaService, SearchService, ChatService, TfaService, ChatGateway, JwtService, OnlineLogerGateway, GameService, GameGateway],
})
